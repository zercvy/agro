...
//           required
//         >
//           <option value="">Выберите климатическую зону</option>
...
const CropRecommendationModal: React.FC<CropRecommendationModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      {noResults && (
        <div className="mt-4 p-4 border rounded bg-yellow-50 text-yellow-700 text-center">
           Рекомендации не найдены по заданным условиям
        </div>
      )}
    </Modal>
  );
